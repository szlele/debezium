...
/**
 * Integration test for {@link PostgresConnector} using an {@link EmbeddedEngine}
 *
...
public class PostgresConnectorIT extends AbstractConnectorTest {
    ...
    public void shouldValidateConfiguration() throws Exception {
        ...
        validateConfigField(validatedConfig, PostgresConnectorConfig.PLUGIN_NAME, LogicalDecoder.MPPDB_DECODING.getValue());
